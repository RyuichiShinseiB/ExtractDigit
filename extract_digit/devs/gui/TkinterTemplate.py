...
pokemon_info = [
    ...
    ["Ekans", "Poison", "288"],
    ["Arbok", "Poison", "448"],
    ["Pikachu", "Electric", "320"],
    ["Raichu", "Electric", "485"],
    ["Sandshrew", "Ground", "300"],
    ["Sandslash", "Ground", "450"],
    ["Nidoran?", "Poison", "275"],
    ["Nidorina", "Poison", "365"],
    ...
    ["Vulpix", "Fire", "299"],
    ["Ninetales", "Fire", "505"],
    ["Jigglypuff", "Normal", "270"],
    ["Wigglytuff", "Normal", "435"],
    ["Zubat", "Poison", "245"],
    ["Golbat", "Poison", "455"],
    ["Oddish", "Grass", "320"],
    ["Gloom", "Grass", "395"],
    ...
    ["Abra", "Psychic", "310"],
    ["Kadabra", "Psychic", "400"],
    ["Alakazam", "Psychic", "500"],
    ["Machop", "Fighting", "305"],
    ["Machoke", "Fighting", "405"],
    ["Machamp", "Fighting", "505"],
    ["Bellsprout", "Grass", "300"],
    ["Weepinbell", "Grass", "390"],
    ["Victreebel", "Grass", "490"],
    ["Tentacool", "Water", "335"],
    ["Tentacruel", "Water", "515"],
    ["Geodude", "Rock", "300"],
    ["Graveler", "Rock", "390"],
    ["Golem", "Rock", "495"],
    ["Ponyta", "Fire", "410"],
    ...
    ["Slowpoke", "Water", "315"],
    ["Slowbro", "Water", "490"],
    ["Magnemite", "Electric", "325"],
    ["Magneton", "Electric", "465"],
    ["Farfetch'd", "Normal", "377"],
    ["Doduo", "Normal", "310"],
    ["Dodrio", "Normal", "470"],
    ["Seel", "Water", "325"],
    ["Dewgong", "Water", "475"],
    ...
    ["Krabby", "Water", "325"],
    ["Kingler", "Water", "475"],
    ["Voltorb", "Electric", "330"],
    ["Electrode", "Electric", "490"],
    ["Exeggcute", "Grass", "325"],
    ["Exeggutor", "Grass", "530"],
    ["Cubone", "Ground", "320"],
    ["Marowak", "Ground", "425"],
    ["Hitmonlee", "Fighting", "455"],
    ["Hitmonchan", "Fighting", "455"],
    ["Lickitung", "Normal", "385"],
    ["Koffing", "Poison", "340"],
    ["Weezing", "Poison", "490"],
    ["Rhyhorn", "Ground", "345"],
    ["Rhydon", "Ground", "485"],
...
class LoginPage(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        main_frame = tk.Frame(
            self, bg="#708090", height=431, width=626
        ...
        frame_login = tk.Frame(
            main_frame, bg="blue", relief="groove", bd=2
        ...
        button = ttk.Button(
            frame_login, text="Login", command=lambda: getlogin()
        )
        ...
        def validate(username, password):
            ...
            try:
                ...
                print(
                    "You need to Register first or amend Line 71 to     if True:"  # noqa: E501
                )
                return False
...
class SignupPage(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        button = ttk.Button(
            main_frame, text="Create Account", command=lambda: signup()
        )
            ...
            if not validation:
                ...
                if len(pw) > 3:
                    ...
                    tk.messagebox.showerror(
                        "Information",
                        "Your password needs to be longer than 3 values.",
                    )
...
class MenuBar(tk.Menu):
    def __init__(self, parent):
        ...
        menu_file.add_command(
            label="Exit Application", command=lambda: parent.Quit_application()
        )
        ...
        menu_help.add_command(
            label="Open New Window", command=lambda: parent.OpenNewWindow()
        )
...
class Some_Widgets(GUI):  # inherits from the GUI class
    def __init__(self, parent, controller):
        ...
        frame1 = tk.LabelFrame(
            self,
            frame_styles,
            text="This is a LabelFrame containing a Treeview",
        )
        ...
        button1 = tk.Button(
            frame2, text="tk button", command=lambda: Refresh_data()
        )
        button1.pack()
        button2 = ttk.Button(
            frame2, text="ttk button", command=lambda: Refresh_data()
        )
        button2.pack()
        ...
        lbox_btn = tk.Button(
            frame2, name="show selected", command=lambda: fetch_lbox()
        )
        lbox_btn.pack(side="left")

        def fetch_lbox() -> None:
            selected = Lbox1.curselection()
            print([Lbox1.get(s) for s in selected])

        Var3 = tk.IntVar()
        R1 = tk.Radiobutton(
            frame2, text="tk Radiobutton1", variable=Var3, value=1
        )
        R1.pack()
        R2 = tk.Radiobutton(
            frame2, text="tk Radiobutton2", variable=Var3, value=2
        )
        R2.pack()
        R3 = tk.Radiobutton(
            frame2, text="tk Radiobutton3", variable=Var3, value=3
        )
        R3.pack()

        R4 = tk.Radiobutton(
            frame2, text="ttk Radiobutton1", variable=Var3, value=1
        )
        R4.pack()
        R5 = tk.Radiobutton(
            frame2, text="ttk Radiobutton2", variable=Var3, value=2
        )
        R5.pack()
        R6 = tk.Radiobutton(
            frame2, text="ttk Radiobutton3", variable=Var3, value=3
        )
        R6.pack()

        # This is a treeview.
        tv1 = ttk.Treeview(frame1, show="tree")
        ...
        tv1.pack(side="top", fill="both", expand=True)

        tv_fetch_btn = ttk.Button(frame1, command=lambda: fetch_data())
        tv_fetch_btn.pack()
        ...
        def fetch_data() -> None:
            record_ids = tv1.selection()
            print(record_ids)
            selected_tv1 = [
                tv1.item(record_id, option="values")
...
class PageOne(GUI):
    def __init__(self, parent, controller):
        ...
        label1 = tk.Label(
            self.main_frame, font=("Verdana", 20), text="Page One"
        )
...
class PageThree(GUI):
    def __init__(self, parent, controller):
        ...
        label1 = tk.Label(
            self.main_frame, font=("Verdana", 20), text="Page Three"
        )
        label1.pack(side="top")
...
class PageFour(GUI):
    def __init__(self, parent, controller):
        ...
        label1 = tk.Label(
            self.main_frame, font=("Verdana", 20), text="Page Four"
        )
        label1.pack(side="top")
...
class PageTwo(GUI):
    def __init__(self, parent, controller):
        ...
        label1 = tk.Label(
            self.main_frame, font=("Verdana", 20), text="Page Two"
        )
        label1.pack(side="top")
...
class OpenNewWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        label1 = tk.Label(
            frame1, font=("Verdana", 20), text="OpenNewWindow Page"
        )
        label1.pack(side="top")
